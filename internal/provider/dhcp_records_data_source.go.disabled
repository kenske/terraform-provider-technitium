...
var (
	_ datasource.DataSource              = &dhcpRecordsDataSource{}
	_ datasource.DataSourceWithConfigure = &dhcpRecordsDataSource{}
)

func NewDhcpRecordsDataSource() datasource.DataSource {
	return &dhcpRecordsDataSource{}
}

// coffeesDataSource is the data source implementation.
type dhcpRecordsDataSource struct {
	client *hashicups.Client
}

// coffeesDataSourceModel maps the data source schema data.
type dhcpRecordsDataSourceModel struct {
	Records []dhcpRecordModel `tfsdk:"records"`
}

// coffeesModel maps coffees schema data.
type dhcpRecordModel struct {
...
func (d *coffeesDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *dataseource.MetadataResponse) {
